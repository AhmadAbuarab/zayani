            ...
            <table id="cars" class="display" cellspacing="0" width="100%">
                <thead>
                    <tr>
                        ...
                        <th>Arabic Car Name</th>
                        <th>English Car Name</th>
                        <th>Arabic Car Model Name</th>
                        <th>English Car Model Name</th>
                        <th>Delete</th>
                        <th></th>
                        <th></th>
                    </tr>
                ...
                <tbody>
                    ...
                    <tr>
                        <td>{{$allDetail->detail_ar}}</td>
                        <td>{{$allDetail->detail_en}}</td>
                        <td>{{$allDetail->car}}</td>
                        <td>{{$allDetail->car_en}}</td>
                        <td>{{$allDetail->car_model}}</td>
                        <td>{{$allDetail->car_model_en}}</td>
                        <td>
                            <input id="carId" type="hidden" value="{{$allDetail->id}}">

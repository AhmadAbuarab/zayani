...
<header id="myCarousel" class="carousel slide">
        ...
        <div class="carousel-inner">
            <div class="item active">
                ...
                <div class="fill" style="background-image:url({{URL::asset('assets/img/slider_1.png') }});"></div>
                <div class="carousel-caption">
<!--                 	<div class="sliderTitle">
                    <h1>F-PACE</h1>
                    <span>ABOVE ALL, IT'S A JAGUAR</span>
                    </div> -->
                    <a href="offers.html"><button class="btn btn-primary sliderButton"><i class="fa fa-chevron-right" aria-hidden="true"></i> المزيد </button></a>

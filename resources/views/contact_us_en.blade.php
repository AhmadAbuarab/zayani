...
google.maps.event.addDomListener(window, 'load', init_map);</script>
                        ...
                        <ul>
                            <li>Address : {{$contactUsPageData[0]->address_en}},</li>
                            <li>P.O.Box : {{$contactUsPageData[0]->po_box_en}}</li>
                            <li>Tel Office :{{$contactUsPageData[0]->telephone}}</li>
                        </ul>

                        <h2>OPENING HOURS</h2>
                        <h3>SHOWROOM</h3>
                        <ul>
                            <li>{{$contactUsPageData[0]->showroom_openning_hours}}</li>
                        ...
                        <ul>
                            <li>{{$contactUsPageData[0]->servuce_and_parts_openning_hours}}</li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <footer>
			...
			<ul class="addressList">
				...
				<li>{{$contactUsData[0]->address_en}}</li>
				<li>P.O.Box: {{$contactUsData[0]->po_box_en}}</li>
			</ul>
		</div>
		<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
